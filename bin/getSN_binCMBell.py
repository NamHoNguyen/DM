...
for noise,(lmin,lmax),Lmax,beam,fsky,Lmin,prefix,est in itertools.product(noises,lRange,Lmaxs,beams,fskys,Lmins,prefixs,ests):
    ...
    i+=1
    if i==len(data):
        np.savetxt('data/June3_binCMBell_beam0.3_noise'+str(noise)+'.csv',data)
        i=0
'''
# Get Total S/N
lRange = [(100,45000)]
...
##### Plot It #########
data1 = np.loadtxt('data/June3_binCMBell_beam0.3_noise0.1.csv')
data2 = np.loadtxt('data/June3_binCMBell_beam0.3_noise0.5.csv')
#datasum1 = 75.921184986 
#datasum2 = 14.4615715985
...
plt.savefig('output/June3_binCMBell_beam0.3.pdf')
#plt.show()
